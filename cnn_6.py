...
W_conv1 = weight_variable([5, 5, 1, 64])	# computing 128 features (shared weights)
b_conv1 = bias_variable([64])	# 128 shared bias for 32 features
...
W_conv2 = weight_variable([5, 5, 64, 128])	# 256 features in this layer
...
for i in range(10000):
	if i%100 == 0:
		...
		if not stop_train_check(test_acc):
			break
...
for i,j in zip(train_acc, test_acc):
