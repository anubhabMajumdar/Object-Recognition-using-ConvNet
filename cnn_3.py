...
W_conv1 = weight_variable([5, 5, 1, 128])	# computing 128 features (shared weights)
b_conv1 = bias_variable([128])	# 128 shared bias for 32 features
...
W_conv2 = weight_variable([5, 5, 128, 256])	# 256 features in this layer
